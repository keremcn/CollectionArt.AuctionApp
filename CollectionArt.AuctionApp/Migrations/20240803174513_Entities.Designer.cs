...
namespace CollectionArt.AuctionApp.Migrations
{
    ...
    [Migration("20240803174513_Entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectionArt.AuctionApp.Entities.Auctions.Auction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("HighestOffer")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CollectionArt.AuctionApp.Entities.Bids.Bid", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CollectionArt.AuctionApp.Entities.Galleries.Gallery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CollectionArt.AuctionApp.Entities.Items.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CollectionArt.AuctionApp.Entities.Profiles.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CollectionArt.AuctionApp.Entities.Auctions.Auction", b =>
                {
                    b.HasOne("CollectionArt.AuctionApp.Entities.Items.Item", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CollectionArt.AuctionApp.Entities.Bids.Bid", b =>
                {
                    b.HasOne("CollectionArt.AuctionApp.Entities.Auctions.Auction", null)
                        .WithMany()
